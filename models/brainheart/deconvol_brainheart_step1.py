		...
		for iteration in range(numb_of_iterations):
			...
			for init_type in range(len(init_types)):
				...
				for profile in range(len(TZ)):
					...
					print 'Profile ' + str(profile) + ' brain cor is ' + str(scipy.stats.spearmanr(TZ[profile], pure_brain)[0])
					print 'Profile ' + str(profile) + ' heart cor is ' + str(scipy.stats.spearmanr(TZ[profile], pure_heart)[0])
					print 'Profile ' + str(profile) + ' brain norm is ' + str(np.linalg.norm(TZ[profile] - pure_brain))
					print 'Profile ' + str(profile) + ' heart norm is ' + str(np.linalg.norm(TZ[profile] - pure_heart))
