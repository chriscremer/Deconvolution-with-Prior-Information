...
def main():
	...
	for iteration in range(numb_of_iterations):
		...
		numb_components = [5, 10, 20, 50, 100]
	...
	pbc.plot_three_lines_with_text(scores_to_plot, scores_to_plot2, scores_to_plot3, numb_components, 'L2-Norm', 'Number of Components', '../plots/norm_vs_components.png', text)
