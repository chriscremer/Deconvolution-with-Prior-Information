...
if __name__ == "__main__":
	...
	for iter_to_avg in range(average_over_x_iters):
		...
		for var in x_values:
			...
			print 'Var ' + str(var) 
			print 'Making data...'
			subpops, fractions, X = mrsd.make_and_return(n_subpops=var, n_samps=n_samps, probability_of_zero=p_of_zero, noise=noise1)
	...
	nice_plot.plot_lines_2graphs_errorbars2(x_values, W_error_avg, W_error_std, models, 'Number of Hidden Components', 'W Reconstruction Error', 'na', 1, 0)
	nice_plot.plot_lines_2graphs_errorbars2(x_values, Z_error_avg, Z_error_std, models, 'Number of Hidden Components', 'Z Reconstruction Error', 'comps_plot.png', 0, 1)
