...
def main():
	...
	pbc.plot_three_lines_with_text(scores_to_plot, scores_to_plot2, scores_to_plot3, p_h_list, 'L2-Norm', 'Fraction Non-Zero', '../plots/norm_vs_frac_non_zero91.png', text)
