...
def main():
	...
	for numb_components in range(min_components, max_components+1):
		...
		for iteration in range(numb_of_iterations):
			...
			n_samples = [10, 50, 100, 200, 500, 1000, 1500, 2000, 5000]
	...
	pbc.plot_three_lines_with_text(scores_to_plot, scores_to_plot2, scores_to_plot3, p_h_list, 'L2-Norm', 'Number of Samples', '../plots/norm_vs_samples.png', text)
