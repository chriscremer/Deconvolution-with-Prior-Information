...
#remove the sum to 1 constraint
...
def Projection_model(X, n_comps, tol):
...
def Projection_fit_model(X, n_comps, tol, real_weights):
	fractions = real_weights
...
def Exhaustive_Search_model(X, n_comps, tol, real_weights):
	fractions = real_weights
